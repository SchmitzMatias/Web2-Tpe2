...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2022 a las 20:00:52
...
(27, 'Nuevo producto', 'delete from products where id=25', 9, 21),
(28, 'Nuevo producto', 'bla; delete from products where id=25', 9, 21);
